...
// export default function SavedLists(item, value) {

//     return (
//         <React.Fragment>
//             <Link to="/">
//                 <h3><i class="fas fa-arrow-left" /> Saved Lists</h3>
//             </Link>
//             <Link to="/">
//                 <p style={{ float: "right", paddingRight: "20px" }}>Create New List</p>
//             </Link>

//             <div class="col-12 col-md-6 col-lg-4" id="{{ItemID}}">
//                 <div class="saved-list-item" style={{ border: "1px solid #c3baba !important;" }}>
//                     <div class="saved-list-item-title">
//                         <h3 class="name">{}</h3> <span>
...
//                     </div>
//                     <ul>
//                         <li class="licss">items in list: {}</li>
//                         <li class="licss">total value ₹  {}</li>
//                     </ul>
//                     <div class="saved-list-btn" style={{ textAlign: "center;" }}>
//                         <button id="{{ItemID}}" type="button" class="btn btn-outline-secondary btnradius" onclick="location.href = 'Cart.html'">order now </button>
//                     </div>
//                 </div>
//             </div>

//             <div class="card" style={{ width: "30rem", height: "18rem", marginTop: "3rem" }}>
//                 <div class="card-body">
//                     <h4 class="card-title">List</h4>
//                     <p class="card-subtitle mb-2 text-muted">Items In List: {}</p>
//                     <p class="card-subtitle mb-2 text-muted">Total Value ₹ {}</p>
